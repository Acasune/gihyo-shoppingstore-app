          ...
          <Box>
            <Box marginBottom={1}>
              {/*
                ...
                Display user info. Always fetch latest info by useUser
             */}
            ...
            {/*
              User product card list container
              Display product card list user possesses. Always fetch latest infer by useSearch
           */}
