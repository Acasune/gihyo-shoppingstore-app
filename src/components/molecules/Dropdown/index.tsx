...
interface DropdownProps {
  ...
  hasError?: boolean
  /**
   * event handler when value changes
   */
  ...
  return (
    <DropdownRoot ref={dropdownRef}>
      ...
      >
        ...
        {/* showing placeholder when nothing is inputted */}
        {!selectedItem && (
