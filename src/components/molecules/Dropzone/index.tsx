...
interface DropZoneProps {
  ...
  hasError?: boolean
  /**
   * event handler when file dropped
   */
  onDrop?: (files: File[]) => void
  /**
   * event handler when file inputted
   */
...
const Dropzone = (props: DropZoneProps) => {
  ...
  // when mouse point whose state is drug is dropped in the realm
  ...
  // Remove focus when drugged mouse point gets out of the realm
  ...
  // Focusing when not drugged mouse point comes into the realm
  ...
  // Showing dialog of file selection
  const handleClick = () => {
  ...
  return (
    <>
      {/* management of drug and drop events */}
      <DropzoneRoot
        ref={rootRef}
        isFocused={isFocused}
        onDrop={handleDrop}
